...
pageheader:
  left: Pre-print, April 2025
  right: 'Vinkesteijn and Kapitan. An open-source reference implementation of a federated composable datastack'
...
{{< include sections/architecture.qmd >}}
