...
% The paper headers
\markboth{Pre-print, April 2025}{Vinkesteijn and Kapitan. An open-source
reference implementation of a federated composable datastack}
...
\pagebreak[3]
\begin{IEEEbiography}[\includegraphics{yannick.png}]{Yannick
Vinkesteijn}
Use \texttt{IEEEbiography} with figure as option and the author name as
the argument followed by the biography text.
\end{IEEEbiography}
\begin{IEEEbiography}[\includegraphics{daniel.jpg}]{Daniel Kapitan}
